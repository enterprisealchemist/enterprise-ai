...
const IntroductionSlide: React.FC<SlideProps> = ({ title }) => {
  ...
  return (
    <div className="slide h-full flex flex-col items-center justify-center p-8" onClick={nextStep}>
      <AnimatePresence>
        {step >= 1 && (
          <motion.blockquote
            ...
            exit={{ opacity: 0, y: -20 }}
            className="border-l-4 border-blue-500 pl-6 py-2 italic text-gray-700 max-w-3xl text-xl"
          >
